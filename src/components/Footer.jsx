...
<footer class="bg-white ">
    <div class="mx-auto w-full max-w-screen-xl">
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
        <img src="assets/footer.png" alt="" height="100%" width="71%" className="w-[100%] lg:h-[100%] lg:w-[71%]"/>
      </div>
        ...
        <div className="text-center lg:text-start">
            ...
            <ul class="text-black font-medium">
                ...
                <li class="mb-4">
                    <a href="/blogs" class=" font-bold">Blogs</a>
                </li>
                <li class="mb-4">
                    <a href="/aboutus" class=" font-bold">About</a>
                </li>
                <li class="mb-4">
        ...
        <div className="text-center lg:text-start">
            ...
            <ul class="text-black font-medium">
                <li class="mb-4">
                    <a href="/privacy" class=" font-bold">Privacy Policy</a>
                </li>
                <li class="mb-4">
                    <a href="/disclaimer" class=" font-bold">Disclaimer</a>
                </li>
                <li class="mb-4">
                    <a href="/terms" class=" font-bold">Terms &amp; Conditions</a>
                </li>
            </ul>
        </div>
        <div className="text-center lg:text-start">
            <h2 class="mb-6 text-sm font-bold text-gray-900 uppercase dark:text-white">Download</h2>
            <ul class="flex flex-col justify-center items-center lg:text-black font-medium lg:flex flex-col justify-start lg:items-start">
                <li class="mb-4">
