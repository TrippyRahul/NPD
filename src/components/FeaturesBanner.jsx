...
const FeaturesBanner = () => {
  return (
    ...
    <h1 class="text-[2.5rem] font-bold mb-4 text-white leading-[3rem] md:text-[3.5rem] md:leading-[4rem]">One Extension<br class="sm:hidden"/> For All Unsecure Websites</h1>
